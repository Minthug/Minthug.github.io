...
따라서 시맨틱 태그는 이 태그가 감싸고 있는 영역이 어떤 역할을 담당하는지 개발자가 쉽게 파악할 수 있도록 도와준다.
...
1. SEO 최적화의 유리
검색엔진은 태그를 기반으로 페이지 내에서 검색 키워드 위주로 우선 순위를 탐색한다.

2. 웹 접근성에 효율적
일반적인 브라우저에서는 차이가 없지만 스크린리더(시각 장애인을 위한 웹 서핑 프로그램)과 같은 환경에서는<br>
웹 접근성과 사용성을 향상시켜준다.

3. 유지보수의 용이성
많은 논시멘틱(Non-semantic) 태그의 사용으로 관리가 어려워지는 문제점에서 벗어나, 태그의 이름만 보고도 어떤 영역인지 바로 확인이 가능하며
...
### main 
이름처럼 문서 body의 중심 주제, 주요 내용 또는 응용 프로그램의 중심 기능과 직접 관련되어나 확장되는 콘텐츠를 나타낸다.


--------

참고URL
https://velog.io/@syoung125/%EC%8B%9C%EB%A7%A8%ED%8B%B1-%ED%83%9C%EA%B7%B8-Semantic-Tag-%EC%9E%98-%EC%82%AC%EC%9A%A9%ED%95%98%EA%B8%B0#%EC%8B%9C%EB%A7%A8%ED%8B%B1-%ED%83%9C%EA%B7%B8-semantic-tag%EB%9E%80
